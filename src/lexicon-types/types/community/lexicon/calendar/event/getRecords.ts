...
const _appBlentoProfileSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecords#appBlentoProfile",
    ),
  ),
  /**
...
const _appBskyActorProfileSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecords#appBskyActorProfile",
    ),
  ),
  /**
...
const _mainSchema = /*#__PURE__*/ v.query(
  "community.lexicon.calendar.event.getRecords",
  {
    params: /*#__PURE__*/ v.object({
      ...
      /**
       * Number of rsvps previews per record
       * @minimum 1
       * @maximum 50
       */
      rsvpsPreview: /*#__PURE__*/ v.optional(
        /*#__PURE__*/ v.constrain(/*#__PURE__*/ v.integer(), [
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecords#profileEntry",
    ),
  ),
...
const _recordSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecords#record",
    ),
  ),
  cid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string()),
  ...
  did: /*#__PURE__*/ v.didString(),
  /**
   * Hydrated related records, grouped by relation name and groupBy value
   */
  hydrates: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.unknown()),
  get record() {
...
declare module "@atcute/lexicons/ambient" {
  interface XRPCQueries {
    "community.lexicon.calendar.event.getRecords": mainSchema;
  }
}
